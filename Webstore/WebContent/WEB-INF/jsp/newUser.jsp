...
<head>
	<title><spring:message code="new"/></title>
			...
			<div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
				<div class="panel panel-default">
        			<div class="panel-body">
        				<h3 class="panel-title"><spring:message code="new"/></h3>
					</div>
				</div>
				...
				<form:form method="POST" modelAttribute="user">
					...
					<div class="panel panel-default">
        				<div class="panel-body">
							...
							<div class="form-group">
								<form:password cssClass="form-control input-sm" path="passwordConfirm" placeholder="${password}" />
					...
					<div class="panel panel-default">
        				<div class="panel-body">
							<button type="submit" class="btn btn-info btn-block"><spring:message code="create"/></button>
						</div>
					</div>
				</form:form>
			</div>
